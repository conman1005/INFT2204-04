...
let newUser = new userClass.User("Conner", "Cullity", "conman1005",  "email@email.com", "password");
 ...
 if ($("#btnRegSubmit")) {
    // TO DO: add a click function that calls a callack function
     $("#btnRegSubmit").click(function (e) {
        ...
        const unvalidatedUser = new userClass.User(
        ...
        // validate first name
        $("#first-group").children(".errorMessage").html(formValidation.validateFirst(unvalidatedUser.firstName));
